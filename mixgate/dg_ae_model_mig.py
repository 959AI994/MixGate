...
class Model(nn.Module):
    ...
    def forward(self, G):
        ...
        num_layers_f = max(G.mig_forward_level).item() + 1
        ...
        # 定义各类型门的掩码
        not_mask = G.mig_gate.squeeze(1) == 2  # NOT 门
        and_mask = G.mig_gate.squeeze(1) == 3  # AND 门
        or_mask  = G.mig_gate.squeeze(1) == 4  # OR 门
        maj_mask = G.mig_gate.squeeze(1) == 1  # Majority 门
