            ...
            for phase in ['train', 'val']:
                ...
                for iter_id, batch in enumerate(dataset):
                    ...
                    if self.local_rank == 0:
                        ...
                        Bar.suffix += '|Params: {:.2f}M '.format(self.total_params_m)  # 新增参数量
                        bar.next()
                ...
                if self.local_rank == 0:
                        self.logger.write('{}| Epoch: {:}/{:} |Prob: {:.4f} |Func: {:.4f}|Prob_Aig: {:.4f} |Prob_Xmg: {:.4f} |Prob_Xag: {:.4f} |Prob_Mig: {:.4f}|Net: {:.2f}s|AvgMem: {:.2f}MB |Params: {:.2f}M\n'.format(
                            phase, epoch, num_epoch, prob_loss_stats.avg,func_loss_stats.avg,prob_loss_aig.avg, prob_loss_mig.avg, prob_loss_xmg.avg, prob_loss_xag.avg,batch_time.avg,mem_mb,self.total_params_m))
                        bar.finish()
